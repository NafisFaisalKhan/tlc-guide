    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 font-montserrat">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
              Complete guide for taxi, Uber, Lyft, and for-hire vehicle drivers
              in New York City
            </p>
          ...
          <Card className="max-w-4xl mx-auto border-slate-200">
            <CardHeader>
              ...
              <CardDescription className="text-slate-600">
                All fees required to obtain your TLC license (costs may vary by
                provider)
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300 border-slate-200">
              ...
              <p className="text-slate-600 text-sm">
                TLC license plates are special commercial license plates issued
                by the NYC Taxi and Limousine Commission for vehicles used in
                for-hire transportation services like taxis, Uber, Lyft, and
                livery cars.
              </p>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300 border-slate-200">
              ...
              <p className="text-slate-600 text-sm">
                ...
                website. You&#39;ll need to log into your TLC account, complete
                the renewal application, pay fees, and submit any required
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300 border-slate-200">
              ...
              <p className="text-slate-600 text-sm">
                To replace a lost TLC license, visit the TLC website to request
                a duplicate license, pay the replacement fee (usually around
                $25), and provide identification. You can also visit a TLC
                office in person.
              </p>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300 border-slate-200">
              ...
              <p className="text-slate-600 text-sm">
                ...
                factors like when the DUI occurred, severity, and whether there
                were multiple offenses. TLC evaluates each case individually
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow duration-300 border-slate-200">
              ...
              <p className="text-slate-600 text-sm">
                ...
                in person with all required documents and no outstanding issues.
              </p>
            </Card>
      ...
      <section id="tlc-contact" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-slate-800 mb-8">Need Help?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg text-slate-700">help@tlcguide.org</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-slate-400">
            <p>
              &copy; 2025 TLC Guide. All rights reserved. Not affiliated with NYC
              TLC.
            </p>
          </div>
        </div>
